	...
	<nav class="navbar navbar-inverse navbar-fixed-top"
		...
		<div class="container-fluid">
			<ul class="nav navbar-nav navbar-left"
				...
				<img src="/ORSProject3/image/customLogoInvertT.png"
					style="margin-top: 10px" width="130" height="52"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<%=ORSView.WELCOME_CTL%>" id="dcolor">
					&emsp;<span class="glyphicon glyphicon-home"
				...
				<ul class="nav navbar-nav navbar-right" style="background:">
					...
					<li><a href="<%=ORSView.LOGIN_CTL%>" id="dcolor"
						...
						style="width: auto; font-family: cursive; color: #e0ebeb;"><span
							...
							style="font-size: 20px; margin-right: 8px;"></span> Login</a></li>
					<li><a href="<%=ORSView.USER_REGISTRATION_CTL%>" id="dcolor">
							<font style="font-family: cursive; color: #e0ebeb"> <span
								class="glyphicon glyphicon-user"
								style="font-size: 20px; margin-right: 10px;"></span>Register
						</font>
					</a></li>
					...
					<li class="dropdown"><a href="" id="dcolor"
						...
						aria-haspopup="true" aria-expanded="false"><span
							aria-hidden="true"></span><b> <span
								...
								<%
									if (userdto != null) {
								%> Hello, <%=userdto.getFirstName()%> ( <%=session.getAttribute("role")%>
 ...
 %>
						...
						<ul class="dropdown-menu" style="background-color: wheat">
							...
							<li><a href="<%=ORSView.CHANGE_PASSWORD_CTL%>"> <span
									class="glyphicon glyphicon-cog" style="color: #0f0f0a"></span>
									<font style="font-family: cursive;"><b>Change
											Password</b></font>
							</a></li>
					...
					<li class="dropdown"><a class="dropdown-toggle" id="dcolor"
						...
						<ul class="dropdown-menu" style="background-color: wheat">
							<li><a href="<%=ORSView.USER_CTL%>"><span
									...
									<font style="font-family: cursive;"><b>Add User</b></font></a></li>
					...
					<li class="dropdown"><a class="dropdown-toggle" id="dcolor"
						...
						<ul class="dropdown-menu" style="background-color: wheat">
							...
							<li><a href="<%=ORSView.TIME_TABLE_LIST_CTL%>"><span
									class="glyphicon glyphicon-list-alt" style="color: #734d26"></span>
									<font style="font-family: cursive;"><b>Time Table
											List</b></font></a></li>
						</ul>
			</div>
			<%
